...
void forth_dictionary_defconst(const char* name, cell value) {
    void* code[] = { 
        forth_dictionary_get_cfa_by_name("lit"), 
        (void*)value, 
        forth_dictionary_get_cfa_by_name("exit") 
    };
...
void deffconst(const char* name, cell value) {
    void* code[] = { forth_dictionary_get_cfa_by_name("flit"), (aliasingfloat*)value, forth_dictionary_get_cfa_by_name("exit") }; 
    forth_dictionary_defword(name, code, 3, FLAG_INLINE);
}
